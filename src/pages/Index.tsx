  ...
  const universities = [
    {
      ...
      description: 'Ведущий технический университет России в области авиастроения'
    },
    {
      name: 'МГТУ им. Баумана',
      fullName: 'Московский государственный технический университет',
      description: 'Престижный технический вуз с сильной программой по авиации'
    },
    {
      name: 'КАИ',
      fullName: 'Казанский национальный исследовательский технический университет',
      description: 'Специализация на авиационных двигателях и конструкциях'
    },
    {
      name: 'СГАУ',
      fullName: 'Самарский национальный исследовательский университет',
      description: 'Подготовка специалистов для ракетно-космической отрасли'
    }
  ];
